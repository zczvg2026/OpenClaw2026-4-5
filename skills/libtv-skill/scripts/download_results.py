...
使用方式:
  ...
  # 指定输出目录
  python3 download_results.py SESSION_ID --output-dir /Users/mac/Desktop/my_project
  ...
  python3 download_results.py --urls URL1 URL2 URL3 --output-dir ./output
    ...
    parser.add_argument("--output-dir", default="", help="输出目录（默认 /Users/mac/Downloads/libtv_results/）")
    ...
    # 准备输出目录
    output_dir = args.output_dir or os.path.expanduser("/Users/mac/Downloads/libtv_results")
