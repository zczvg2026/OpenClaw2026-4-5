...
if [ ! -f "$STATE_FILE" ]; then
  /Users/mac/.openclaw/skills/memory-manager/init.sh > /dev/null 2>&1
fi
...
if [ "$usage" -ge 85 ]; then
  ...
  echo "  1. Run: /Users/mac/.openclaw/skills/memory-manager/snapshot.sh"
  echo "  2. Run: /Users/mac/.openclaw/skills/memory-manager/organize.sh"
  ...
  echo "  1. Run: /Users/mac/.openclaw/skills/memory-manager/organize.sh"
