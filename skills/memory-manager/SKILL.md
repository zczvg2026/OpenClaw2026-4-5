...
```bash
/Users/mac/.openclaw/skills/memory-manager/init.sh
```
...
```bash
/Users/mac/.openclaw/skills/memory-manager/detect.sh
```
...
```bash
/Users/mac/.openclaw/skills/memory-manager/organize.sh
```
...
/Users/mac/.openclaw/skills/memory-manager/search.sh episodic "launched skill"

# Search semantic (what I know)
/Users/mac/.openclaw/skills/memory-manager/search.sh semantic "moltbook"

# Search procedural (how to)
/Users/mac/.openclaw/skills/memory-manager/search.sh procedural "validation"

# Search all
/Users/mac/.openclaw/skills/memory-manager/search.sh all "compression"
```
...
1. Run: /Users/mac/.openclaw/skills/memory-manager/detect.sh
2. If warning/critical: /Users/mac/.openclaw/skills/memory-manager/snapshot.sh
3. Daily at 23:00: /Users/mac/.openclaw/skills/memory-manager/organize.sh
```
...
```bash
# Move episodic entry
/Users/mac/.openclaw/skills/memory-manager/categorize.sh episodic "2026-01-31: Launched Memory Manager"

# Extract semantic knowledge
/Users/mac/.openclaw/skills/memory-manager/categorize.sh semantic "moltbook" "Moltbook is the social network for AI agents..."

# Document procedure
/Users/mac/.openclaw/skills/memory-manager/categorize.sh procedural "skill-launch" "1. Validate idea\n2. Build MVP\n3. Launch on Moltbook..."
```
...
/Users/mac/.openclaw/skills/memory-manager/stats.sh
```
