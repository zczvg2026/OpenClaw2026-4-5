...
Add to `/Users/mac/.config/openclaw/settings.json`:
```json
{
  "skills": {
    "n8n": {
...
> **Security note:** Never store API keys in plaintext shell config files (`/Users/mac/.bashrc`, `/Users/mac/.zshrc`). Use the OpenClaw settings file or a secure secret manager.
