...
git clone https://github.com/op7418/Humanizer-zh.git /Users/mac/.claude/skills/humanizer-zh
```
...
2. 将 `Humanizer-zh` 文件夹复制到 Claude Code 的 skills 目录：
   - **macOS/Linux**: `/Users/mac/.claude/skills/`
   - **Windows**: `%USERPROFILE%\.claude\skills\`

3. 确保文件夹结构如下：
   ```
   /Users/mac/.claude/skills/humanizer-zh/
   ├── SKILL.md       # 技能定义文件（中文版）
   └── README.md      # 说明文档
   ```
