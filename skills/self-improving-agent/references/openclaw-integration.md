...
```bash
cp -r self-improving-agent /Users/mac/.openclaw/skills/
```
...
```bash
cp -r hooks/openclaw /Users/mac/.openclaw/hooks/self-improvement
```
...
```bash
mkdir -p /Users/mac/.openclaw/workspace/.learnings
```

Or in the skill directory:

```bash
mkdir -p /Users/mac/.openclaw/skills/self-improving-agent/.learnings
```
