...
**关键更新**：2026-04-05 Johnson确认ENERGY CELL与域擎OPC联盟是**两个完全独立的项目**，没有关联
  - ⚠️ **OPC = One Person Company（一人公司）** — 不是 Office Park Community（2026-04-30 王鹏纠正）
**状态**：独立推进，与太擎/域擎平行
...
**源码位置**：/Users/mac/Desktop/zczvg/claude-code-complete/（1423个.ts文件）
...
- **配置**：Key存于 `/Users/mac/.openclaw/workspace/skills/libtv-skill/.env`
...
- Johnson 重读 Claude Code 源码（/Users/mac/Desktop/zczvg/claude-code-complete/）+ WeChat文章
...
- ✅ IMA 日记写入打通（2026-04-03 深夜）
  ...
  - 写日记脚本：`/Users/mac/.openclaw/workspace/skills/ima-note/scripts/write_diary.py`
...
**素材状态**：E01-E05 Meigen图已生成（/Users/mac/Pictures/meigen/），E06/E07待生成
...
- **素材存放**：`/Users/mac/Videos/大闸蟹视频号/E0x/`（本地Mac，优于飞书云）
