...
```bash
mkdir -p /Users/mac/.config/ima
echo "your_client_id" > /Users/mac/.config/ima/client_id
echo "your_api_key" > /Users/mac/.config/ima/api_key
```
...
IMA_CLIENT_ID="${IMA_OPENAPI_CLIENTID:-$(cat /Users/mac/.config/ima/client_id 2>/dev/null)}"
IMA_API_KEY="${IMA_OPENAPI_APIKEY:-$(cat /Users/mac/.config/ima/api_key 2>/dev/null)}"
